...
template = (
    """TORCHINDUCTOR_CACHE_DIR=/scratch/bohanhou/fresh/data_timm/[[DTYPE]]_[[MODE]]_[[MODEL_NAME]] TORCH_LOGS="+inductor" TORCHINDUCTOR_BENCHMARK_KERNEL=1 python3 benchmarks/dynamo/timm_models.py --[[DTYPE]] --performance --[[MODE]] --inductor -d cuda --filter [[MODEL_NAME]] """
    + " >"
    + LOG_DIR
...
for DTYPE in ["amp"]:
    for MODE in ["inference", "training"]:
        model_list_path = "/scratch/bohanhou/fresh/pytorch/benchmarks/dynamo/ci_expected_accuracy/inductor_timm_[[MODE]].csv"
        ...
        for model_name in model_names:
            model_path = (
                "/scratch/bohanhou/fresh/data_timm/[[DTYPE]]_[[MODE]]_[[MODEL_NAME]]"
            )
            model_path = (
